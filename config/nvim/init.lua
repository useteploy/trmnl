...
vim.o.number = true
-- Relative line numbers help with jumping (e.g. 5j, 12k)
...
--  NOTE: C-h is not mapped — Zellij captures it for move mode.
--  Use C-w h as the alternative for moving focus left.
--
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = {
        'bash', 'c', 'css', 'diff', 'dockerfile', 'html', 'javascript',
...

  {
    ...
    keys = {
      { '<leader>lo', '<cmd>AerialToggle<CR>', desc = '[L]ist [O]utline' },
    },
  },

  -- NOTE: neotest is now configured in custom/plugins/neotest.lua with language adapters
  -- {
  ...
  -- NOTE: nvim-dap-ui is configured in kickstart/plugins/debug.lua
  -- {
